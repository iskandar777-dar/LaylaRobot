...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Somed*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Somed's licensed under the GNU General Public License v3.0_
                 \n❍ Awesome Bots @kenapatagdar
                 \n❍ Support Group @somedsupport
                 \nHere is the [💾Repository](https://github.com/iskandar777-dar/LaylaRobot).
                 \n\nIf you have any question about Somed, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Somed*
                 \nHere is the [Source Code](https://github.com/iskandar777-dar/LaylaRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
