...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Welcome {first} Sokap - Sokap Aja Disini!.", 
    "Welcome {first} Admin Ada Member Baru Nih.", 
    "Welcome {first} Let's Gabung Circle Kami!.",
    "Welcome {first} Sokap Aja, Disini Adminnya Banyak Yang Jomblo",  
]
DEFAULT_GOODBYE_MESSAGES = [
    "Selamat Tinggal {first}.",
    "Babayy {first} 👋🏻",
    "Selamat Tinggal {first} 👋, Semoga Bertemu Kembali",
]
